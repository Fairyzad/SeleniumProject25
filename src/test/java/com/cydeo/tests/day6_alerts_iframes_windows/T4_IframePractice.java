   ...
   // @Ignore
    ...
    public void iframe_test(){
       ...
       // driver.switchTo().frame("mce_0_ifr");
        ...
        // locate the p tag
        WebElement yourContentGoesHereText = driver.findElement(By.xpath("//p")); // driver is foucing on the root html

        Assert.assertTrue(yourContentGoesHereText.isDisplayed());

        //Verify"An iFrame contaning the TingMCM WYSIWYG Editor";
